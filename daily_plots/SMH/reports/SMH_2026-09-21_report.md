...
### Analysis
**Projected Critical Time:** 2019-02-16

**Observation:** The projected Critical Time (2019-02-16) has passed. Since the crash/correction didn't strictly coincide with this date, the market may have entered a new regime or diffused the bubble pressure sideways.
...
![Fit](../images/SMH_2026-09-21_fit.png)
...
**Observation:** We see 4 signal clusters with confidence > 30%. This 'agreement' across time scales reinforces the validity of the trend identification.

![Confidence](../images/SMH_2026-09-21_confidence.png)
...
![Cumulative](../images/SMH_2026-09-21_cumulative.png)
...
![Table](../images/SMH_2026-09-21_cumulative_table.png)

---

## 5. Analyst Conclusion
### Executive Summary
The analysis for **SMH** (2019-01-01 to 2026-09-21) has detected a total of **52** significant LPPLS signals.
...
**Recent Activity:**
The most recent alert was a **Top** signal observed during **2026-06-02 to 2026-06-03**, peaking at a confidence level of **0.2000**. Traders should watch for price reaction around these levels.
