...
### Analysis
**Projected Critical Time:** 2017-09-02

**Observation:** The projected Critical Time (2017-09-02) has passed. Since the crash/correction didn't strictly coincide with this date, the market may have entered a new regime or diffused the bubble pressure sideways.
...
![Fit](../images/BTC-USD_2026-03-28_fit.png)
...
![Confidence](../images/BTC-USD_2026-03-28_confidence.png)
...
![Cumulative](../images/BTC-USD_2026-03-28_cumulative.png)
...
![Table](../images/BTC-USD_2026-03-28_cumulative_table.png)

---

## 5. Analyst Conclusion
### Executive Summary
The analysis for **BTC-USD** (2019-01-01 to 2026-03-28) has detected a total of **62** significant LPPLS signals.
...
**Recent Activity:**
The most recent alert was a **Top** signal observed during **2025-05-22**, peaking at a confidence level of **0.2222**. Traders should watch for price reaction around these levels.
