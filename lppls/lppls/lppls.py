...
class LPPLS(object):
    ...
    def plot_fit(self, show_tc=False):
        ...
        ax1.plot(time_ord, price, label="price", color="blue", linewidth=0.75)
        ax1.plot(time_ord, lppls_fit, label="lppls fit", color="orange", alpha=0.5)
        # if show_tc:
        ...
        # Use mdates to format the x-axis with Years and Months
        ax1.xaxis.set_major_locator(mdates.YearLocator())
        ax1.xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
        ax1.xaxis.set_minor_locator(mdates.MonthLocator())
        # ax1.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m')) # If zoom is needed
